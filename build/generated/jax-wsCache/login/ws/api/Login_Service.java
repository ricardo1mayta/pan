 ...
 * 
 */
@WebServiceClient(name = "login", targetNamespace = "http://api.ws/", wsdlLocation = "http://192.168.1.212:8080/WSservidor/login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://api.ws/", "login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.212:8080/WSservidor/login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://api.ws/", "loginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.ws/", "loginPort"), Login.class, features);
    }
